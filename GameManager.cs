...
public class GameManager : MonoBehaviour
{
   ...
   // public TextMeshProUGUI powerupText;
    ...
    void Start()
    {
        ...
        InvokeRepeating("CreateShield", 1, 5);
    ...
    void CreateShield()
    {
        Instantiate(shieldPrefab, new Vector3(Random.Range(-horizontalScreenSize, horizontalScreenSize) * 0.3f, Random.Range(-verticalScreenSize, verticalScreenSize), 0), Quaternion.identity);
    }
